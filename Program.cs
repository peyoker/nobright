...
namespace NoBright
{
    ...
    static class Program
    {
        ...
        // Hook de teclado de bajo nivel para capturar teclas incluso en pantalla de bloqueo
        ...
        static System.Threading.Timer holdTimer = null;

        static int[] keyCodes = { 0xA2, 0xA3, 0xA4, 0xA5, 0xA0, 0xA1, 0x5B, 0x5C, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79, 0x7A, 0x7B };
                ...
                if (vkCode == selectedKey)
                {
                    if (wParam == (IntPtr)WM_KEYDOWN)
                    {
                        if (!wasPressed)
                        {
                            ...
                            {
                                // Configurar timer para activar después del tiempo de espera
                                holdTimer?.Dispose();
                                ...
                                }, null, (int)(holdSeconds * 1000), Timeout.Infinite);
                            }
                        }
                    }
