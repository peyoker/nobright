...
namespace NoBright
{
    ...
    static class Program
    {
        ...
        {
            // GetAsyncKeyState es más fiable que GetKeyState en pantalla de bloqueo
            ...
            while (checkingKey)
            {
                try
                {
                    ...
                    else if (keyPressed && wasPressed && holdSeconds > 0)
                    {
                        ...
                        if (elapsed.TotalSeconds >= holdSeconds)
                        {
                            ToggleBrightness();
                            // Resetear para evitar múltiples activaciones
                    ...
                    // Polling cada 20ms para mejor respuesta
                    Thread.Sleep(20);
                }
                catch
                {
